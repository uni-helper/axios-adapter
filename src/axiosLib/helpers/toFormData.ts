 ...
 */
function renderKey(path: any, key: any, dots: any) {
  if (!path) return key;
  return path
    .concat(key)
    .map(function each(token: any, i: any) {
 ...
 * @returns
 */
function toFormData(obj: any, formData: any, options: any) {
  ...
  options = utils.toFlatObject(
    ...
    false,
    function defined(option: any, source: any) {
  ...
  function defaultVisitor(value: any, key: any, path: any) {
    ...
    if (value && !path && typeof value === "object") {
      if (utils.endsWith(key, "{}")) {
        ...
        arr.forEach(function each(el: any, index: any) {
